      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="bg-white rounded-3xl p-12 border-2 border-slate-200 shadow-sm">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {areas.map((city) => (
              <div key={city} className="group flex items-center gap-3 p-5 rounded-xl border-2 border-slate-100 hover:border-blue-400 hover:shadow-md transition-all duration-300">
                ...
                <p className="text-lg font-bold text-slate-900 group-hover:text-blue-600 transition-colors">{city}</p>
              </div>
            ))}
          </div>
        </div>
