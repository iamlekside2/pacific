...
export default function Services() {
  return (
    <section id="services" className="py-32 bg-gradient-to-b from-slate-50 to-white relative overflow-hidden">
      {/* Animated Background Elements */}
      <div className="absolute -top-40 -right-40 w-80 h-80 bg-blue-400/5 rounded-full blur-3xl animate-pulse" style={{animationDelay: '0.3s'}} />
      <div className="absolute bottom-20 -left-40 w-80 h-80 bg-blue-500/5 rounded-full blur-3xl animate-pulse" style={{animationDelay: '1.2s'}} />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          {services.map(({ icon: Icon, title, desc, best }, i) => (
            <div
              key={title}
              className="bg-white rounded-2xl p-8 border-2 border-slate-200 shadow-sm hover:shadow-xl hover:border-blue-400/50 hover:shadow-blue-500/10 transition-all group animate-fade-in-up hover:scale-105 hover:-translate-y-1"
            ...
            >
              ...
              <div className="pt-4">
                <a
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2 text-blue-600 font-semibold hover:bg-blue-500/10 rounded-lg transition-colors text-sm group-hover:text-blue-700"
                >
                  Learn More →
                </a>
              </div>
          ...
          {/* Contact Card */}
          <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl p-8 text-white flex flex-col justify-between shadow-xl shadow-blue-500/30 group animate-fade-in-up" style={{animationDelay: `${0.1 + services.length * 0.06}s`}}>
            ...
            <a
              href="tel:+14434608684"
              className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-white text-blue-600 rounded-lg font-bold hover:bg-slate-100 hover:scale-105 transition-all shadow-lg shadow-blue-500/30"
            >
        ...
        {/* Bottom CTA */}
        <div className="text-center p-12 bg-gradient-to-r from-blue-500/10 to-blue-400/5 rounded-2xl border-2 border-blue-500/20 animate-fade-in-up" style={{animationDelay: '0.4s'}}>
